...
const ServicesSection = () => {
  ...
  const services: Service[] = [
    {
      ...
      category: 'Software',
      icon: <Code2 className="w-6 h-6 md:w-8 md:h-8 text-white" />,
    ...
    },
    {
      ...
      category: 'AI',
      icon: <Brain className="w-6 h-6 md:w-8 md:h-8 text-white" />,
    ...
    },
    {
      ...
      category: 'Design',
      icon: <PenTool className="w-6 h-6 md:w-8 md:h-8 text-white" />,
  ...
  return (
    <div className="relative bg-gradient-to-b from-white via-gray-50/50 to-white dark:from-gray-900 dark:via-gray-950/50 dark:to-gray-900 pt-20 md:pt-24 pb-12 md:pb-16 lg:pb-24 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div 
          ...
          className="text-center max-w-4xl mx-auto mb-8 md:mb-12 lg:mb-16 pt-8"
        >
          <motion.div 
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          >
            <Sparkles className="w-3 h-3 md:w-4 md:h-4 text-red-500 dark:text-red-400" />
        ...
        >
          ...
          <div className="relative mb-6 md:mb-8">
            <div className="absolute left-3 md:left-4 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-400">
            ...
            <input
              ...
              className="w-full pl-10 md:pl-12 pr-4 py-3 md:py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl md:rounded-2xl focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none transition-all text-sm md:text-base text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
            />
          </div>

          {/* Filter Tabs */}
          <div className="flex flex-col items-center gap-3 mb-4">
            <div className="flex items-center gap-2 text-xs md:text-sm text-gray-700 dark:text-gray-400">
              <Filter className="w-3 h-3 md:w-4 md:h-4 text-gray-700 dark:text-gray-400" />
              Filter by:
            </div>
                ...
                <div className="relative h-full bg-white dark:bg-gray-800 rounded-2xl md:rounded-3xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300 hover:shadow-xl md:hover:shadow-2xl hover:border-red-300 dark:hover:border-red-500/50">
                  ...
                  <div className="p-6 md:p-8">
                    <div className="flex items-start justify-between mb-4 md:mb-6">
                      <div className={`p-3 md:p-4 rounded-xl md:rounded-2xl bg-gradient-to-br ${service.gradient}`}>
                        {service.icon}
                      </div>
                      <motion.div
                        animate={{ rotate: hoveredService === service.id ? 360 : 0 }}
                        transition={{ duration: 0.5 }}
                        className="p-1.5 md:p-2 rounded-lg text-red-500 dark:text-red-400 bg-red-50 dark:bg-red-500/10"
                      >
                    ...
                    <div className="space-y-2 md:space-y-3 mb-4 md:mb-6">
                      <h4 className="font-semibold text-gray-800 dark:text-gray-300 text-xs md:text-sm">Services Include:</h4>
                      <div className="flex flex-wrap gap-1.5 md:gap-2">
                        {service.services.slice(0, 3).map((item, idx) => (
                          <span
                            key={idx}
                            className="px-2 py-1 md:px-3 md:py-1.5 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 rounded-lg text-xs md:text-sm font-medium truncate max-w-full"
                            title={item}
                          >
                            {item}
                          </span>
                    ...
                    <div className="space-y-1.5 md:space-y-2 mb-6 md:mb-8">
                      {service.features.map((feature, idx) => (
                        <div key={idx} className="flex items-center gap-2">
                          <CheckCircle2 className="w-3 h-3 md:w-4 md:h-4 text-red-500 dark:text-red-400" />
                          <span className="text-xs md:text-sm text-gray-700 dark:text-gray-400 truncate">{feature}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  {/* Footer */}
                  <div className="px-6 md:px-8 py-4 md:py-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
                      <span className="font-semibold text-sm md:text-base text-red-500 dark:text-red-400">
                        {service.category}
                      </span>
                      <motion.button
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                <div className="flex-1">
                  ...
                  >
                    ...
                    <ExternalLink className="w-4 h-4 md:w-5 md:h-5 text-white opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                  </motion.button>
                </div>
