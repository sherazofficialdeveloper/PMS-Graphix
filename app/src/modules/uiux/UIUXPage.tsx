...
const UIUXPage: React.FC = () => {
  ...
  return (
    <div 
      className="min-h-screen transition-colors duration-500 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-black dark:to-gray-900 text-gray-900 dark:text-gray-100"
    ...
    >
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute w-96 h-96 rounded-full blur-3xl bg-red-500/5 dark:bg-red-500/10"
        ...
        <motion.div
          ...
          className="absolute w-96 h-96 rounded-full blur-3xl bg-red-500/10 dark:bg-red-500/5"
          ...
          >
            ...
            >
              {stats.map((stat, index) => (
                ...
                >
                  <div className="text-4xl font-black mb-2 text-red-600 dark:text-red-400">
                    {stat.value}
                  </div>
                    ...
                    <ul className="space-y-2 mb-6">
                      {service.features.map((feature, idx) => (
                        <li key={idx} className="flex items-center">
                          <CheckCircle2 className="mr-2 text-red-500 dark:text-red-400" size={16} />
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 md:px-6 lg:px-8">
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative overflow-hidden rounded-[4rem] p-12 md:p-16 bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-black dark:to-gray-900 border border-gray-200 dark:border-gray-800"
            >
              {/* Decorative Elements */}
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                    ...
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="px-10 py-5 rounded-2xl font-bold text-lg border-2 backdrop-blur-sm bg-white/50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-100 hover:bg-white/70 dark:hover:bg-gray-800/50 transition-all"
                    >
                      Schedule a Call
                    </motion.button>
                  </div>
